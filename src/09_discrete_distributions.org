...
** Problem 9.1
   A structure is located in a region of possible tornadoes. From records for the past 20 years, the mean occurrence rate of tornadoes is once every 10 years. Assume that tornado occurrence can be modeled as a Poisson process. The structure is designed to withstand a tornado force with an allowable probability of damage of 20%. /Hint:/ $\sum_{n=0}^{\infty} \dfrac{x^n}{n!} = e^{x}$
   #+reveal: split
   What is the probability that the structure will be damaged in the next 50 years?
   #+reveal: split
   If the structure were to be upgraded to reduce the 50-year probability of damage to 5%, what should the allowable damage probability against a tornado be?
   #+reveal: split
   The regional government plans to upgrade 10 similar structures to this standard (5%). What is the probability that at most one of the upgraded structures would be damaged in the next 50 years?
** Problem 9.2
   ...
   #+reveal: split
   In any of the corrosion sites, there may be one or more cracks that could cause fracture failure. If the probability of this even occurring at a corrosion site is 0.001, what is the probability of fracture failure along the entire 100-km pipeline?
** Mean and variance
   #+reveal_html: <div class="block">
