...
** Independence of multiple events
   The events $E_1$, $E_2$,...,$E_n$ are /independent/ if and only if for any 
...
** {{{empty}}}
   ...
   - Imagine police encounter 90 white and 10 black civilians
   - 5 black and 9 white civilians are shot
